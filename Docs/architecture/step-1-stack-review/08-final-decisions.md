...
| **Local Database** | ObjectBox | Latest | Max mobile performance, no SQL |
...
| 04 | 04-local-database.md | ObjectBox | ✅ Locked |
...
| Database | ObjectBox | NoSQL simplicity, fastest mobile DB, reactive queries |
...
- [ ] Configure ObjectBox with `objectbox.dart`  
